...
extension ResponsiveContext on BuildContext {
  ...
  bool get isSmallScreen =>
      MediaQuery.sizeOf(this).width < ResponsiveBreakpoints.small;

  /// Whether the device width is considered large (>=768dp, tablet).
  bool get isLargeScreen =>
      MediaQuery.sizeOf(this).width >= ResponsiveBreakpoints.large;
  ...
  /// ```
  T responsive<T>({required T small, T? medium, required T large}) {
  ...
  double get horizontalPadding =>
      responsive(small: 12.0, medium: 16.0, large: 24.0);
}
