...
class FeaturedChapterCard extends StatelessWidget {
  const FeaturedChapterCard({super.key, required this.chapter, required this.subjectId});
      ...
      child: Column(
        ...
        children: [
          ...
          Text(chapter.subtitle, style: AppTextStyles.bodySmall.copyWith(
            color: colorScheme.onSurfaceVariant, height: AppDimensions.lineHeightDefault,
          )),
          const SizedBox(height: AppDimensions.paddingXL),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(AppStrings.completedOfFormulas(chapter.completedFormulas, chapter.totalFormulas),
                style: AppTextStyles.bodySmall.copyWith(color: colorScheme.outline, fontWeight: FontWeight.w700)),
              Text(
                chapter.progressPercent > 70 ? AppStrings.nearlyThere
                    : chapter.progressPercent > 30 ? AppStrings.keepGoing : AppStrings.justStarted,
                style: AppTextStyles.bodySmall.copyWith(color: colorScheme.primary, fontWeight: FontWeight.w700),
              ),
            ],
          ),
          const SizedBox(height: AppDimensions.paddingSM),
          ProgressBar(
            percentage: chapter.progressPercent, height: AppDimensions.progressBarMD,
            backgroundColor: colorScheme.secondaryContainer.withValues(alpha: AppDimensions.opacityLight),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: Text(ctaText),
              label: const Icon(LucideIcons.arrowRight, size: AppDimensions.iconMD),
