...
/// A **data-driven** subject card widget.
///
/// Replaces the former build methods.
///
/// All visual properties (icon, color, badge, mastery, lastViewed,
/// subtitle) come from the [Subject] entity, so **any** subject
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          // Conditional: mastery progress bar
          ...
          // Conditional: subtitle (e.g. "Recommended for Boards")
