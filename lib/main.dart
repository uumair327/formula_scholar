...
void main() {
  ...
  runZonedGuarded(
    () async {
      ...
      if (!kIsWeb) {
        // Prefer explicit Dart-define value, otherwise try Firebase-generated fallback.
        String serverClientId = _googleSignInServerClientId;
        if (serverClientId.isEmpty) {
          try {
            // FirebaseOptions may include client IDs generated by the FlutterFire CLI.
            // The web/android client id is sometimes placed in the iOS options as
            // `androidClientId` by the generator; use it as a safe fallback.
